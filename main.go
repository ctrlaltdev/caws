...
var TraceableRegions = [...]string{"us-east-1", "us-east-2", "us-west-1", "us-west-2"}

var profile = flag.String("profile", "", "aws profile to use")
...
// ServiceNameFromARN GetServiceFromArn removes the arn:aws: component string of
...
// ShortArn Short ARN removes the unnecessary info from the ARN we already
...
// ConvertArnToSingleResource GetResourceRow shortens the ARN and assigns it to the right
